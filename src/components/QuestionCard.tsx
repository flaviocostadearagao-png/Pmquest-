      ...
      >
        ...
        >
          ...
          <div className="text-[11px] leading-tight">
            <span className="font-bold text-amber-500 uppercase tracking-wide">{currentQuestao.disciplina}</span>
        ...
        <div className="px-4 pb-4 space-y-2.5">
          ...
          {currentQuestao.alternativas.map((alt) => {
            ...
            let containerClasses = isDark
              ? 'border-slate-800 bg-[#0c1e3a]/40 hover:bg-[#0c1e3a]/60 text-slate-200'
            ...
            if (!foiRespondida && isSelected) {
              containerClasses = isDark
                ...
                : 'border-blue-700 bg-blue-50 text-blue-950 ring-2 ring-blue-700/20 font-medium';
              badgeClasses = 'bg-amber-500 text-slate-950 border-amber-500';
